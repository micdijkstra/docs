...
export const meta = {
  title: 'Introduction to ZEIT Now Test Repo',
  description:
...
Once you have [signed up to ZEIT](/signup), you can use our [Git integrations](/docs/v2/git-integration) with [GitHub](/docs/v2/more/now-for-github), [GitLab](/docs/v2/more/now-for-gitlab), or [Bitbucket](/docs/v2/more/now-for-bitbucket) to deploy an existing project – then with a deployment for every push – by selecting a repository from your Git account.
